  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/3 left-1/4 w-[500px] h-[500px] bg-accent/5 rounded-full blur-[200px]" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn delay={0.65}>
            <div className="relative mx-auto max-w-xs lg:max-w-sm">
              <div className="absolute inset-0 bg-accent/5 rounded-xl blur-[80px] -z-10" />
              <div className="rounded-xl border border-white/10 bg-surface/80 p-10 text-left">
